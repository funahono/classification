...
save_dir = f'/media/honoka/HDD1/Funatsuki/Experiment/{day_sub}/svm_3class/current_k={k_num}_{kernel_type}_tiebreak'
...
for k in range(k_num):
    ...
    predkun , decision = predict_ovo_with_tiebreak(modelkun, test_data) #predkun: pred label #decision:margin score of each model( num of data × num of machine )
    ...
    #decision
    print(decision)
    # decision_0 = decision[train_labels == 0]

...
for k in range(k_num):
    ...
    ########################### save png ##########################################
    #save paht
    save_confusion_png_path = os.path.join(save_dir, f'current_{day_sub}_Rindex_vs_Rlittle_{kernel_type}_{f_range[0]}_{f_range[1]}Hz_{t_range[0]}_{t_range[1]}s_{k+1}.png')
    save_report_file_path = os.path.join(save_dir, f'current_{day_sub}_Rindex_vs_Rlittle_classification_report.txt')
    save_report_csv_path = os.path.join(save_dir, f'current_{day_sub}_Rindex_vs_Rlittle_classification_report.csv')

...
% current_days = {'20250313','20250305','20250305'};
current_day = '20250525';
tasks = {'Rindex','Lindex','Rlittle'};%'Rindex', 'Lindex','Rlittle'
t_range = [0 3];
f_range = [13 15];
t_paradigm = [-3 7];

load_base_dir = '/media/honoka/HDD2/MATLAB/vbmeg_analysis/';
save_dir = '/media/honoka/HDD2/Experiment';
...
for task_idx = 1:length(tasks)
    ...
    disp(['----------------------[ ' task '  ]----------------------']);
    % load dir
    % load_dir = '/media/hdd1/Funatsuki/MATLAB/vbmeg_analysis/20241111_B92_Rindex_20241112_ear_ref_car_standard_brain/tf_map_n_cycles_15_ref_-3_-1';
...
save(save_path, 'right_index_mean','left_index_mean','right_little_mean','n_epochs', 'n_channels', 'n_freqs', 'n_times','t_range','f_range','t_paradigm'); % 'Rindex_mean','Lindex_mean','Rlittle_mean'
...
index_dict_list = [
    'right_index_mean',  # 20241111_B92
    'right_index_mean',  # 20241115_B94
    'right_index_mean',  # 20241121_B99
    'right_index_mean',  # 20241122_C02
    'right_index_mean',  # 20241126_B95
    'right_index_mean',  # 20241223_B90
    'right_index_mean',  # 20250107_B97
    'Rindex_mean',       # 20250206_B92
    'Rindex_mean'        # 20250313_B93
]

little_dict_list = [
    'right_little_mean',  # 20241111_B92
    'right_little_mean',  # 20241115_B94
    'right_little_mean',  # 20241121_B99
    'right_little_mean',  # 20241122_C02
    'right_little_mean',  # 20241126_B95
    'right_little_mean',  # 20241223_B90
    'right_little_mean',  # 20250107_B97
    'Rlittle_mean',       # 20250206_B92
    'Rlittle_mean'        # 20250313_B93
]

left_dict_list = [
    'left_index_mean',   # 20241111_B92
    'left_index_mean',   # 20241115_B94
    'left_index_mean',   # 20241121_B99
    'left_index_mean',   # 20241122_C02
    'left_index_mean',   # 20241126_B95
    'left_index_mean',   # 20241223_B90
    'left_index_mean',   # 20250107_B97
    'Lindex_mean',       # 20250206_B92
    'Lindex_mean'        # 20250313_B93
]
comment ='Only_C_CP'
...
for day_sub , f_range, t_range, index_dict, little_dict, left_dict in zip(day_sub_list, f_range_list, t_range_list, index_dict_list, little_dict_list, left_dict_list):

    ######################### dir & path ###########################################

    # dir
    read_dir = f'/media/honoka/HDD1/Funatsuki/Experiment/{day_sub}/mean'
    save_dir = f'/media/honoka/HDD1/Funatsuki/Experiment/{day_sub}/svm_3class/EEG_{comment}_{kernel_type}_tiebreak'
    # read_dir = f'/media/honoka/HDD2/Experiment/{day_sub}/mean'
    # save_dir = f'/media/honoka/HDD2/Experiment/{day_sub}/svm_3class/EEG_{comment}_k={k_num}_{kernel_type}_tiebreak'
    ...
    Rlittle_data = data_dict[little_dict]
    Rindex_data = data_dict[index_dict]
    Lindex_data = data_dict[left_dict]
    ...
    ch_num = Rlittle_data.shape[0]

    #sort data in chronological order and set label(Rindex:0,Lindex;1,Rlittle:2)
    data = np.zeros((20*3*class_num, ch_num)) #(60 × 3 class, 20 channnels)

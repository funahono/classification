...
%read filename
erds_data_dir_filename = "/media/hdd1/Funatsuki/Experiment/20250206_B92/result";
save_data_dir_filename = "/media/hdd1/Funatsuki/Experiment/20250206_B92/mean";

%paradigm
tasks = {'Rindex', 'Lindex','Rlittle'}; %'right_index', 'left_index','right_little'
t_range = [0 3];
f_range = [10 15];
t_paradigm = [-3 7]; 
sampling_rate = 2500;
...
save(save_path, 'right_index_mean','left_index_mean','right_little_mean','eeg_channel','n_epochs', 'n_channels', 'n_freqs', 'n_times','t_range','f_range','t_paradigm'); %'right_index_mean','left_index_mean','right_little_mean'
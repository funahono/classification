...
save_dir = f'/media/honoka/HDD1/Funatsuki/classification/binary'
...
for subject in subject_list:
    ...
    ## eeg data #############
    eeg_read_file = f'{read_dir}/{subject}/svm/EEG_{eeg_comment}/EEG_{subject}_Rindex_vs_Lindex_classification_report.csv'
...
# *.png file
fig_acc.savefig(os.path.join(save_dir,'Rindex_vs_Lindex_all_sub_acc.png'),bbox_inches='tight')
fig_fscore.savefig(os.path.join(save_dir,'Rindex_vs_Lindex_all_sub_f1score.png'),bbox_inches='tight')

# *.txt file
save_file_name_txt = 'Rindex_vs_Lindex_all_sub.txt'

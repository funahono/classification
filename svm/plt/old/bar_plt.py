...
matrix = np.array([
    ...
    ['B90', '75.83', '86.66','83.33','90.00'],
    ['B97', '59.17', '70.00','53.33','70.83']
])

save_dir = 'C:/Users/Hono/Desktop/datadir/svm'
...
for i, subject in enumerate(subjects):
    ...
    plt.savefig(os.path.join(save_dir, f'{subject}_accuracy.png'), bbox_inches='tight')
...
plt.bar(x + width/2, current_acc_right_left, width, label='current', color=colors[2],edgecolor='black')
...
plt.bar(x4 + width/2, current_acc_index_little, width, label='current', color=colors[4],edgecolor='black')

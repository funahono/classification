# -*- coding: utf-8 -*-
"""
Created on Thu Mar 20 12:54:47 2025
...
matrix = np.array([ #['B92_1','31.67','70.00','38.33','71.67'],
                    ['A','90.00','83.33','66.67','73.33'],#B94
                    ['B','34.17','70.83','46.67','67.50'],#B99
                    ['C','80.00','85.00','80.83','92.50'],#C02
                    ['D', '78.33', '80.83','76.67','86.67'],#B95
                    ['E', '75.83', '86.67','83.33','90.00'],#B90
                    ['F', '59.17', '70.00','53.33','70.83'],#B97
                    ['G','46.67','64.17','50.00','65.00']])#B92
...
plt.figure(figsize=(12, 5))
plt.bar(x - width/2, eeg_acc_index_little, width, label='EEG', color=colors[3],edgecolor='black')
plt.bar(x + width/2, current_acc_index_little, width, label='cortical\ncurrent', color=colors[4],edgecolor='black')
...
for d ,subject in enumerate(subjects):
    position = width*(d+0.5-len(subjects)*0.5)
    plt.bar(x2[0] + position, eeg_acc_index_little[d], width, label=subject, color=colors[d+5+3],edgecolor='black')
    plt.bar(x2[1] + position, current_acc_index_little[d], width, color=colors[d+5+3],edgecolor='black')
plt.xticks(x2, method)
#plt.title('all subject( each method )')
plt.ylabel('Accuracy (%)')
plt.ylim(0, 100)
